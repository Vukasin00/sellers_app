...
import 'package:sellers_app/uploadScreens/menu_upload_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(pinned:true,delegate:TextWidgetHeader(title:"Moje Stavke Iz: "+ widget.model!.menuTitle.toString() + " Menija")),
